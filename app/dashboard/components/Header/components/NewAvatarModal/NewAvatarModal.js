...
export default function NewAvatarModal({isOpen, onOpenChange, handleUpdateLogo}) {
  ...
  return (
    ...
    >
      <ModalContent>
        {onClose => (
          <>
            <ModalHeader className="flex flex-col gap-1">Nowy avatar klubu</ModalHeader>
            <ModalBody>
              <div>
                <input
                  type="file"
