...
import {updateAthleteOtherDetails} from '../../../../actions/updateAthlete';
...
const OtherDetailsCard = ({athleteId, refetchAthleteData, otherDetails = []}) => {
  ...
  const handleSaveChanges = handleSubmit(async data => {
    try {
      ...
      const {success} = await updateAthleteOtherDetails({
        id: athleteId,
